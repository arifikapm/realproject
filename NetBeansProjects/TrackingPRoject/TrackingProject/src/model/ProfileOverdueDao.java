 ...
 * @author kuupie
 */
public class ProfileOverdueDao extends ListCell<ProfileOverdue>{
...
//"and p.master_activity_idactivity=1";
    ...
    protected void updateItem(ProfileOverdue list, boolean empty) {
        ...
        if(empty || list == null) {
            ...
            if (mLLoader == null) {
                mLLoader = new FXMLLoader(getClass().getResource("/view/ListCellProfileOverdue.fxml"));
            ...
            String value = String.valueOf(list.getOverDue());
            textCivitas.setText(list.getActivityCol());
